...
Depending on initialization parameters and timestep, different variables are accessible.
    ...
    +-----------------------------+-----------------------------------------------------+
    |callback                     |Since timestep 0                                     |
    +-----------------------------+-----------------------------------------------------+
    |episode_rewards              |Since timestep 0                                     |
    +-----------------------------+-----------------------------------------------------+
    |episode_successes            |Since timestep 0                                     |
    +-----------------------------+-----------------------------------------------------+
    ...
    |kwargs                       |timestep 1                                           |
    +-----------------------------+-----------------------------------------------------+
    |update_eps                   |timestep 1                                           |
    +-----------------------------+-----------------------------------------------------+
    |update_param_noise_threshold |timestep 1                                           |
    +-----------------------------+-----------------------------------------------------+
    |action                       |timestep 1                                           |
    +-----------------------------+-----------------------------------------------------+
    |env_action                   |timestep 1                                           |
    +-----------------------------+-----------------------------------------------------+
    |new_obs                      |timestep 1                                           |
    +-----------------------------+-----------------------------------------------------+
    |rew                          |timestep 1                                           |
    ...
    |reward_                      |timestep 2                                           |
    +-----------------------------+-----------------------------------------------------+
    |can_sample                   |timestep 2                                           |
    +-----------------------------+-----------------------------------------------------+
    |ep_rew                       |timestep 2 and writer is not None                    |
    +-----------------------------+-----------------------------------------------------+
    |ep_done                      |timestep 2 and writer is not None                    |
    +-----------------------------+-----------------------------------------------------+
    |experience                   |after the first rollout                              |
    +-----------------------------+-----------------------------------------------------+
    |obses_t                      |after the first rollout                              |
    +-----------------------------+-----------------------------------------------------+
    |actions                      |after the first rollout                              |
    +-----------------------------+-----------------------------------------------------+
    |rewards                      |after the first rollout                              |
    +-----------------------------+-----------------------------------------------------+
    |obses_tp1                    |after the first rollout                              |
    +-----------------------------+-----------------------------------------------------+
    |dones                        |after the first rollout                              |
    +-----------------------------+-----------------------------------------------------+
    |weights                      |after the first rollout                              |
    +-----------------------------+-----------------------------------------------------+
    |batch_idxes                  |after the first rollout                              |
    +-----------------------------+-----------------------------------------------------+
    |summary                      |after the first rollout and writer is not None       |
    +-----------------------------+-----------------------------------------------------+
    |td_errors                    |after the first rollout and writer is not None       |
    +-----------------------------+-----------------------------------------------------+
    |run_options                  |if writer is not None and after 100 steps            |
    +-----------------------------+-----------------------------------------------------+
    |run_metadata                 |if writer is not None and after 100 steps            |
    +-----------------------------+-----------------------------------------------------+
